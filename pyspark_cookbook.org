...
#+PROPERTY: header-args:python :noweb strip-export :exports both :results output raw replace :session pyspark
...
#+name: pretty2orgtbl
#+begin_src python :var data="" :exports none :results output raw :session none :exports none
  import re
  state_prev = ""
  prev_line = ""
...
#+RESULTS:
:results:
75a187bdd6b678b70ee3dc397f849370
:end:
